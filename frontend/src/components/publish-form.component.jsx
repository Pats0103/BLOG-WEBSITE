...
let {userAuth:{access_token}} = useContext(UserContext)
  ...
  const handlePublishBlog = (e) => {
    ...
    if (!des.length||des.length>textLimit) {
      return toast.error("Description cannot be empty or more than 400 characters");
    }
        ...
        childern={
          ...
          onChange={handleDesChange}
              ...
              <div className="relative input-box pl-2 pr-2 pb-4">
                ...
                <p className="mt-1 mb-4 text-dark-grey text-right">{tagLimit-tags.length} left</p>
                <button className="btn-dark"

                onClick={e=>handlePublishBlog(e)}
                >
                  Publish
                </button>
            </div>
